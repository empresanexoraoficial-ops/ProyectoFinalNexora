...
function cargarDashboard() {
  ...
  document.getElementById('dash-ingresos-mes').textContent = fmt(ventasMes.reduce((s,v) => s + v.total, 0));
  document.getElementById('dash-ventas-mes').textContent   = ventasMes.length + ' ventas';
